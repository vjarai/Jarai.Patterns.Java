package jarai.patterns.behavioral.state.pattern.tests;

import jarai.patterns.behavioral.state.pattern.Abgehoben;
import jarai.patterns.behavioral.state.pattern.Aufgelegt;
import jarai.patterns.behavioral.state.pattern.Telefon;
import jarai.patterns.behavioral.state.pattern.Verbunden;
