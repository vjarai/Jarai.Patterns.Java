package jarai.patterns.behavioral.state.prozedural.tests;

import jarai.patterns.behavioral.state.prozedural.Telefon;
import jarai.patterns.behavioral.state.prozedural.TelefonZustand;
